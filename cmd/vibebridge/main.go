...
func runAgent(args []string) error {
	...
	background := flags.Bool("background", true, "hide the Agent console window (default: true when tray is enabled)")
	tray := flags.Bool("tray", true, "show Windows system tray controls (default: true on Windows)")
