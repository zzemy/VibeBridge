...
- WebSocket connections require paired-device credentials (Ed25519-signed nonce). A per-run token still bootstraps the local status and web-session endpoints.
