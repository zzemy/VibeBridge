...
- Protocol V1 application ping/pong is not active yet; previous-client compatibility coverage and the removable legacy adapter also remain migration work.
